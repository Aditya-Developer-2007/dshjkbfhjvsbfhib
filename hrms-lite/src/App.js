...
function App() {
  ...
  const handleMarkAttendance = async (e) => {
    ...
    if (!selectedEmp) return alert("Please select a valid employee.");
    await API.post('/attendance', { ...attForm, fullName: selectedEmp.fullName });
    setAttForm({ ...attForm, employeeId: '', status: 'Present', remarks: '' });
    fetchData();
    alert("Record Saved!");
  };
